            ...
            <div className="border-b border-zinc-800 p-5">
                <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                        ...
                        className="rounded-full border border-zinc-800 bg-[#0F1115] px-2 py-1 text-xs text-zinc-500 transition hover:border-[#7C72FF]/50 hover:text-zinc-200 hover:shadow-md hover:shadow-[#7C72FF]/10"
                    >
                        ‹
                    </button>
                </div>
                ...
                {notes.length > 0 ? (
                    notes.map((note) => {
                        ...
                        return (
                            <div
                                key={note.id}
                                className={`group relative overflow-hidden rounded-2xl border p-4 text-left transition ${isActive
                                    ? "border-[#7C72FF]/50 bg-[#20242D] shadow-lg shadow-[#7C72FF]/10"
                                    : "border-zinc-800 bg-[#141820] hover:border-zinc-700 hover:bg-[#1A1E26]"
                                    }`}
                            >
                                <div
                                    className={`absolute left-0 top-0 h-full w-1 transition ${isActive ? "bg-[#7C72FF]" : "bg-transparent"
                                        }`}
                                />
